// Site Navigation (copy) - Updated August 11, 2023
function noop() { }
const identity = x => x;
...
function create_each_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "link svelte-py8ywp");
		...
		p(ctx, dirty) {
			if (dirty & /*site_nav*/ 1 && t_value !== (t_value = /*link*/ ctx[7].label + "")) set_data(t, t_value);

			if (dirty & /*site_nav*/ 1 && a_href_value !== (a_href_value = /*link*/ ctx[7].url)) {
...
function create_if_block$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(button, "class", "svelte-py8ywp");
			attr(nav, "id", "popup");
			attr(nav, "class", "svelte-py8ywp");
		},
		m(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			attr(nav, "class", "svelte-py8ywp");
			attr(div0, "class", "desktop-nav svelte-py8ywp");
			attr(button, "id", "open");
			attr(button, "aria-label", "Open mobile navigation");
			attr(div1, "class", "mobile-nav svelte-py8ywp");
			attr(header, "class", "section-container svelte-py8ywp");
		},
		m(target, anchor) {
...
function instance$1($$self, $$props, $$invalidate) {
	...
	return [site_nav, mobileNavOpen, props, logo, click_handler, click_handler_1];
}

class Component$1 extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$1, create_fragment$1, safe_not_equal, { props: 2, logo: 3, site_nav: 0 });
	}
}
