...
// (115:6) {#each social as { label, link }}
function create_each_block_1(ctx) {
	...
	let t1;
	let a;
	let t2_value = /*link*/ ctx[13].label + "";
	let t2;
	let a_href_value;
	let t3;
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*social*/ 2 && t0_value !== (t0_value = /*label*/ ctx[12] + "")) set_data(t0, t0_value);
			if (dirty & /*social*/ 2 && t2_value !== (t2_value = /*link*/ ctx[13].label + "")) set_data(t2, t2_value);

			if (dirty & /*social*/ 2 && a_href_value !== (a_href_value = /*link*/ ctx[13].url)) {
...
function create_else_block(ctx) {
	let label;
	let span;
	let t0_value = /*input*/ ctx[9].label + "";
	let t0;
	let t1;
	let input;
	...
	return {
		...
		h() {
			...
			attr(input, "type", input_type_value = /*input*/ ctx[9].type || "text");
			attr(input, "placeholder", input_placeholder_value = /*input*/ ctx[9].placeholder);
		...
		p(ctx, dirty) {
			if (dirty & /*inputs*/ 1 && t0_value !== (t0_value = /*input*/ ctx[9].label + "")) set_data(t0, t0_value);

			if (dirty & /*inputs*/ 1 && input_type_value !== (input_type_value = /*input*/ ctx[9].type || "text")) {
				attr(input, "type", input_type_value);
			}

			if (dirty & /*inputs*/ 1 && input_placeholder_value !== (input_placeholder_value = /*input*/ ctx[9].placeholder)) {
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			attr(span, "class", "svelte-1twigpw");
			attr(textarea, "placeholder", textarea_placeholder_value = /*input*/ ctx[9].placeholder);
		...
		p(ctx, dirty) {
			...
			if (dirty & /*inputs*/ 1 && textarea_placeholder_value !== (textarea_placeholder_value = /*input*/ ctx[9].placeholder)) {
...
// (126:4) {#each inputs as input, i}
function create_each_block(ctx) {
	let if_block_anchor;

	function select_block_type(ctx, dirty) {
		if (/*input*/ ctx[9].type === "textarea") return create_if_block;
...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			form_1 = claim_element(section_nodes, "FORM", { submit: true, class: true });
		...
		h() {
			...
			attr(form_1, "submit", /*submit_form*/ ctx[4]);
			attr(form_1, "class", "svelte-1twigpw");
...
function instance($$self, $$props, $$invalidate) {
	...
	return [inputs, social, heading, subheading, submit_form, props];
}
