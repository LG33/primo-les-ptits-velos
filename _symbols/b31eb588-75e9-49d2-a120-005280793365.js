...
function create_each_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "link svelte-x7r224");
...
function create_if_block$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(button, "class", "svelte-x7r224");
			attr(nav, "id", "popup");
			attr(nav, "class", "svelte-x7r224");
		},
		m(target, anchor) {
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			attr(a0, "href", "/");
			attr(a0, "class", "logo svelte-x7r224");
			attr(nav, "class", "svelte-x7r224");
			attr(div0, "class", "desktop-nav svelte-x7r224");
			attr(a1, "href", "/");
			attr(a1, "class", "logo svelte-x7r224");
			attr(button, "id", "open");
			attr(button, "aria-label", "Open mobile navigation");
			attr(div1, "class", "mobile-nav svelte-x7r224");
			attr(header, "class", "section-container svelte-x7r224");
		},
		m(target, anchor) {
